<div class="row">
    ...
    <div class="col-12">
        <div class="article">
            ...
            <form method="post" action="/dashboard/structure/update?id=<?=$element['id']?>">
                <div class="mb-20px">
                    <label for="title" class="form-label">Заголовок элемента</label>
                    <input type="text" name="title" value="<?=$element['title']?>" id="title" class="form-control" placeholder="Введите заголовок элемента">
                </div>
                <div class="mb-20px">
                    <label for="description" class="form-label">Описание элемента</label>
                    <input type="text" name="description" value="<?=$element['description']?>" id="description" class="form-control" placeholder="Введите описание элемента">
                </div>
                <div class="mb-20px">
                    ...
                    <select id="parent" name="parent" class="form-control">
                        ...
                        <?php foreach($structures as $structure): ?>
                            <?php if($element['parent_id']==$structure['id']): ?>
